...
export default function SelectAnime() {
    return (
        <>
        <Head>
            <title>Rank Anime | AniRanker</title>
        ...
        <div className="text-center mb-5 bg-white py-6 rounded-md shadow-md mx-10">
            <h1 className="text-3xl font-extrabold">Select an Anime</h1>
            <p className="font-lato text-gray-600 text-sm">Click the image of the better anime to rank them.</p>
        </div>
